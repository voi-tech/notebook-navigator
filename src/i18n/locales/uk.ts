...
export const STRINGS_UK = {
    ...
    searchInput: {
        ...
        searchHelpModal: {
            intro: 'Комбінуйте імена файлів, теги, дати та фільтри в одному запиті (напр. `meeting #work @thisweek has:task`). Встановіть плагін Omnisearch для повнотекстового пошуку.',
            introSwitching:
            ...
            sections: {
                ...
                properties: {
                    ...
                    items: [
                        ...
                        '`.key=value` Включити нотатки з користувацьким значенням властивості (також збігається з вкладеними значеннями, наприклад `value/subvalue`).',
