...
export const STRINGS_RU = {
    ...
    searchInput: {
        ...
        searchHelpModal: {
            intro: 'Комбинируйте имена файлов, теги, даты и фильтры в одном запросе (напр. `meeting #work @thisweek has:task`). Установите плагин Omnisearch для полнотекстового поиска.',
            introSwitching:
