...
export const STRINGS_FA = {
    ...
    searchInput: {
        ...
        searchHelpModal: {
            intro: 'نام فایل‌ها، برچسب‌ها، تاریخ‌ها و فیلترها را در یک جستجو ترکیب کنید (مثال: `meeting #work @thisweek has:task`). افزونه Omnisearch را نصب کنید تا از جستجوی متن کامل استفاده کنید.',
