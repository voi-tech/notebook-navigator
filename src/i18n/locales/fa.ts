...
export const STRINGS_FA = {
    ...
    searchInput: {
        ...
        searchHelpModal: {
            intro: 'نام فایل‌ها، برچسب‌ها و تاریخ‌ها را در یک جستجو ترکیب کنید (مثال: `meeting #work @thisweek`). Omnisearch از جستجوی متن کامل استفاده می‌کند و توکن‌های برچسب و تاریخ را نادیده می‌گیرد.',
            sections: {
                fileNames: {
                    title: 'نام‌های فایل',
                    items: [
            ...
            searchProvider: {
                ...
                info: {
                    filterSearch: {
                        ...
                        description:
                            'فایل‌ها را بر اساس نام و برچسب در پوشه و زیرپوشه‌های فعلی فیلتر می‌کند. حالت فیلتر: متن و برچسب‌های ترکیبی با تمام عبارات مطابقت دارند (مثل "پروژه #کار"). حالت برچسب: جستجو فقط با برچسب‌ها از عملگرهای AND/OR پشتیبانی می‌کند (مثل "#کار AND #فوری"، "#پروژه OR #شخصی"). Cmd/Ctrl+کلیک روی برچسب‌ها برای افزودن با AND، Cmd/Ctrl+Shift+کلیک برای افزودن با OR. پشتیبانی از حذف با پیشوند ! (مثل !پیش‌نویس، !#بایگانی) و یافتن یادداشت‌های بدون برچسب با !#. از فیلترهای تاریخ با پیشوند @ پشتیبانی می‌کند (مثلاً @today، @2026-02-04، @2026-02-01..2026-02-04). از @c: یا @m: برای هدف قرار دادن تاریخ ایجاد/ویرایش استفاده کنید، و از !@ برای حذف بازه‌ها. فیلد تاریخ پیش‌فرض از مرتب‌سازی فعلی پیروی می‌کند؛ هنگام مرتب‌سازی بر اساس نام، از تنظیمات ← یادداشت‌ها ← تاریخ ← هنگام مرتب‌سازی بر اساس نام استفاده می‌شود.'
                    },
                    omnisearch: {
                        title: 'Omnisearch:',
                        description:
