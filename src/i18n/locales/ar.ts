...
export const STRINGS_AR = {
    ...
    searchInput: {
        ...
        searchHelpModal: {
            intro: 'ادمج أسماء الملفات والوسوم والتواريخ والمرشحات في استعلام واحد (مثال: `meeting #work @thisweek has:task`). قم بتثبيت إضافة Omnisearch لاستخدام البحث في النص الكامل.',
