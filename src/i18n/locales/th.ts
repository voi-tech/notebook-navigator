...
export const STRINGS_TH = {
    ...
    searchInput: {
        ...
        searchHelpModal: {
            intro: 'รวมชื่อไฟล์ แท็ก และวันที่ในคำค้นหาเดียว (เช่น `meeting #work @thisweek`) Omnisearch ใช้การค้นหาข้อความเต็มและไม่สนใจโทเค็นแท็กและวันที่',
            sections: {
                fileNames: {
                    title: 'ชื่อไฟล์',
                    items: [
            ...
            searchProvider: {
                ...
                info: {
                    filterSearch: {
                        ...
                        description:
                            'กรองไฟล์ตามชื่อและแท็กภายในโฟลเดอร์และโฟลเดอร์ย่อยปัจจุบัน โหมดตัวกรอง: ข้อความและแท็กผสมจะจับคู่ทุกเงื่อนไข (เช่น "โปรเจค #งาน") โหมดแท็ก: การค้นหาด้วยแท็กเท่านั้นรองรับตัวดำเนินการ AND/OR (เช่น "#งาน AND #ด่วน", "#โปรเจค OR #ส่วนตัว") Cmd/Ctrl+คลิกที่แท็กเพื่อเพิ่มด้วย AND, Cmd/Ctrl+Shift+คลิกเพื่อเพิ่มด้วย OR รองรับการยกเว้นด้วยคำนำหน้า ! (เช่น !ฉบับร่าง, !#เก็บถาวร) และค้นหาโน้ตที่ไม่มีแท็กด้วย !# รองรับตัวกรองวันที่ที่มีคำนำหน้า @ (เช่น @today, @2026-02-04, @2026-02-01..2026-02-04) ใช้ @c: หรือ @m: เพื่อกำหนดเป้าหมายวันที่สร้าง/แก้ไข และ !@ เพื่อไม่รวมช่วง ฟิลด์วันที่เริ่มต้นตามการเรียงลำดับปัจจุบัน เมื่อเรียงตามชื่อ ใช้การตั้งค่า → โน้ต → วันที่ → เมื่อเรียงตามชื่อ'
                    },
                    omnisearch: {
                        title: 'Omnisearch:',
                        description:
