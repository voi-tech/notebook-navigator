...
const RELEASE_NOTES: ReleaseNote[] = [
    {
        ...
        new: [
            ...
            'New Style setting: Calendar > ==Right sidebar date placement==. You can choose to show dates in the calendar in the right sidepane bottom right (default) or centered.'
        ],
        improved: [
